...
const userAccess_middleware_1 = require("../../middlewares/userAccess.middleware");
const clientRoutes = (app) => {
    app.use(setting_middleware_1.settingGeneral);
    app.use(auth.checkUserClient);
    app.use(userAccess_middleware_1.userAccess);
    app.use(`/topics`, topic_route_1.topicRoutes);
    app.use(`/songs`, song_route_1.songRoutes);
    app.use(`/favorite`, favorite_song_route_1.favoriteRoutes);
